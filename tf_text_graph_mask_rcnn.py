...
parser.add_argument('--input', default='pb/frozen_inference_graph.pb', help='Path to frozen TensorFlow graph.')
parser.add_argument('--output', default='pb/mask_rcnn_out.pbtxt', help='Path to output text graph.')
parser.add_argument('--config', default='mask_rcnn_inception_v2_coco.config', help='Path to a *.config file is used for training.')
